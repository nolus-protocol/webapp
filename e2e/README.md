...
| `E2E_OSMOSIS_LCD`        | no       | Osmosis LCD origin the t3 IBC flow probes for counterparty funding (bank balances of the primary's osmo-prefixed address). Defaults to `https://lcd.osmosis.zone`.                                                                                                                            |
