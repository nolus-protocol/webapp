...
const ADJECTIVES = [
  "Cosmic", "Stellar", "Brave", "Swift", "Noble", "Zen", "Lucky", "Bold",
  "Vivid", "Epic", "Funky", "Bright", "Chill", "Daring", "Fierce", "Grand",
  "Happy", "Jolly", "Keen", "Lively", "Mighty", "Nifty", "Plucky", "Quick",
  "Rad", "Slick", "Turbo", "Ultra", "Witty", "Zesty", "Atomic", "Blazing"
];

const NOUNS = [
  "Panda", "Falcon", "Otter", "Fox", "Wolf", "Lynx", "Raven", "Tiger",
  "Comet", "Nova", "Pixel", "Spark", "Orbit", "Pulse", "Reef", "Bolt",
  "Crane", "Drake", "Flint", "Gecko", "Hawk", "Ibex", "Jade", "Kite",
  "Lotus", "Mango", "Opal", "Pike", "Quail", "Sage", "Viper", "Wren"
];
