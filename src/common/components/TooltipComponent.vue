<template>
  ...
  <Teleport to="body">
    <div
      ref="tooltip"
      class="tooltip tooltip-animations absolute mb-7 flex flex-col items-center group-hover:flex"
    >
      <div class="relative flex">
        <span
          class="text-normal whitespace-no-wrap content relative z-10 bg-light-electric p-2 text-left leading-none text-white shadow-lg"
        >
          {{ content }}
        </span>
        <div
          ref="triangle"
          class="absolute -mt-2 h-3 w-3 bg-light-electric"
