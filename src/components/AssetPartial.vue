<template>
  <div
    class="asset-partial nolus-box grid gap-6 relative border-b border-standart py-3 px-3 md:px-6 items-center justify-between"
    :class="[
