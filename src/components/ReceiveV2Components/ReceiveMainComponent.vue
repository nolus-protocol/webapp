...
import ReceiveComponent, { type ReceiveComponentProps } from "@/components/ReceiveV2Components/ReceiveComponent.vue";
import ReceiveQrCodeComponent, { type ReceiveQrCodeComponentProps } from "@/components/ReceiveV2Components/ReceiveQrCodeComponent.vue";
