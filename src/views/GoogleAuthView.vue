  ...
  <div class="block w-screen md:w-[516px] -mt-8 md:mt-auto">
    <div class="background rounded-2xl md:border nls-border shadow-box md:filter-none outline">
      ...
      <div class="flex px-4 md:px-10 pt-10 relative z-[2] lg:pt-6">
        ...
        <button 
          class="btn btn-box btn-large-box ml-5 md:ml-4 basis-0 grow" @click="googleAuth()"
      ...
      <div class="align-center justify-center pt-7 text-center mx-auto md:flex">
        <button 
          class="btn btn-primary btn-large-primary w-80 mb-4 md:mb-10" :class="{ 'js-loading': loadingGoogle }"
    ...
    <div class="md:hidden flex align-center justify-center md:pt-7 pt-4 text-center mx-auto background absolute inset-x-0 bottom-0 md:relative shadow-modal z-[100]">
      <button 
        class="btn btn-primary btn-large-primary w-80 mb-4 lg:mb-10" :class="{ 'js-loading': loadingGoogle }"
        @click="clickCreateAccount">
        {{ $t("message.create-new-account") }}
      </button>
    </div>
