<template>
  <div v-cloak class="block w-screen md:w-[516px] -mt-8 md:mt-auto">
    <div
      class="bg-white rounded-2xl md:border border-standart shadow-box md:filter-none"
    >
      <h1
      ...
      <div
        class="bg-white h-[420px] absolute inset-x-0 bottom-0 z-[0] md:hidden"
      ></div>
    ...
    <div
      class="md:hidden flex align-center justify-center md:pt-7 pt-4 text-center mx-auto bg-white absolute inset-x-0 bottom-0 md:relative shadow-modal z-[100]"
    >
      <button
